...
<h3 style="text-align: center;color:blue"><b> Shiko Vizitat Online </b></h3>
...
$query = "Select * FROM Vizita";
$sql = mysqli_query($conn, $query);
echo "<table border='1' color:black align='center'>";
echo "<tr align='center'> </tr>";
echo "<tr align='center'>
    <th style='color:black'> Nr. </th>
    <th style='color:black'>Emer Mbiemer</th>
    <th style='color:black'> Nr. Celularit </th>
    <th style='color:black'> Shërbimi Mjekësor</th>
    <th style='color:black'>Email</th>
    <th style='color:black'>Veprimi i Fshirjes</th>
    </tr>";
...
while($row = mysqli_fetch_array($sql)){
    echo "<tr align='center'>
        ...
        <td style='color:black'>".$row["Nr_Celularit"]."</td>
        <td style='color:black'>".$row["Sherbimet_Mjekesore"]."</td>
        <td style='color:black'>".$row["Email"]."</td>
        <td style='color:black'><a href='fshiviziten.php?Id=".$row[0]."'>Fshi Vizitën</td>
