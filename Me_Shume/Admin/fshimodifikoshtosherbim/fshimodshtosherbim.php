...
<h3 style="text-align: center;color:blue"><b> Fshi,Modifiko dhe Shto Shërbimet Mjekësor </b></h3>
...
$query = "Select * FROM Sherbimet_Mjekesore";
$sql = mysqli_query($conn, $query);
echo "<table border='1' color:black align='center'>";
echo "<tr align='center'> </tr>";
echo "<tr align='center'>
    <th style='color:black'> Nr. </th>
    <th style='color:black'>Titulli</th>
    <th style='color:black'> Përshkrimi </th>
...
while($row = mysqli_fetch_array($sql)){
    echo "<tr align='center'>
        ...
        <td style='color:black'><a href='fshish.php?Id=".$row[0]."'>Fshi Stafin Mjekesor</td>
        <td style='color:black'><a href='modifikosh.php?Id=".$row[0]."'>Modifiko Stafin Mjekesor</td>
        <td style='color:black'><a href='../Shto Sherbimin/Shto_Sherbimin_Mjekesor.php'> Shto Shërbimin </td>
<tr>";
}
echo "</table>";
mysqli_close($conn);
