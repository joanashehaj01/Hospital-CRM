...
$query = "SELECT * FROM Doktoret WHERE Id_Doktori =".$id;
...
if(isset($_POST["edit"])){
        ...
        $sql="UPDATE Doktoret SET Emer_Mbiemer='".$emri."', CV='".$cv."',Specializimi='".$specializimi."' WHERE Id_Doktori=".$id;
        $res = mysqli_query($conn,$sql );
    if($res)
        { echo 'Update u be me sukses!'; 
    header("Location:Sistemi_Fshi_Modifiko.php");
...
<form action="Modifiko.php?Id=<?php echo $id;?>" method="POST">
    <table style="text-align: left">
        <tr><td style="color:black">Emer Mbiemer<td><input type="text" style="color:black" name="emri" value="<?php echo $row[1];?>"/></td></td></tr><tr></tr>
        <tr><td style="color:black"> CV <td><input type="text" style="color:black" name="cv" value="<?php echo $row[2];?>"/><br></td></td></tr>
        <tr><td style="color:black">Specializimi<td><input type="text" style="color:black" name="specializimi" value="<?php echo $row["Specializimi"];?>"/></td></td></tr><tr></tr>
          
        <tr></tr>     
<tr><td colspan="2"> <input type="submit" style="color:black" value="Modifiko Doktor" id="edit" name="edit" /></td>
</tr>
</table>
</form>
