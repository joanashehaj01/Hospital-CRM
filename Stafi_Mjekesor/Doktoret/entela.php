...
$query = "SELECT * FROM Doktoret where Emer_Mbiemer='DR. ENTELA TOPTANI'";
...
$dir_path = "../../Me_Shume/Admin/Shto Stafin/Imazhe/";
...
sort($images);
    ...
    if (count($images) > 0) { // make sure at least one image exists
        $img = $images[1]; // first image
        echo "<br>";
        echo "<img src='$img' height='450' width='50%' class='center' /> ";
    } else {
